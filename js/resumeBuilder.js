...
bio.display = function() {
    ...
    $("#topContacts").append(formattedmobile, formattedemail, formattedtwitter,
        formattedblog, formattedlocation);
...
education.display = function() {
    education.schools.forEach(function(school) {
        ...
        $(".education-entry:last").append(formattedName.replace("#", school.url) + formattedDegree, formattedDates, formattedLocation, formattedMajor);
    });
